...
import { CommandResponse, TransactionListing, TransactionSaveRequest } from "../../typeDefinitions";
...
const validateSaveRequest = (saveTransactionRequest: TransactionSaveRequest): CommandResponse<TransactionListing> => {
	...
	} else if ((saveTransactionRequest.transactionType == null)
		|| isNaN(saveTransactionRequest.transactionType)) {
